...
export const APP_FEATURES = [
  {
    ...
    description:
      "Get interview questions and model answers based on your role, experience, and specific focus areas, ensuring your preparation is truly personalized.",
  },
  {
    id: "02",
    title: "Learn at Your Own Pace",
    description:
      "Expand answers only when you're ready. Dive deeper into any concept instantly with AI-powered detailed explanations, without feeling overwhelmed.",
  },
  {
    id: "03",
    title: "Capture Your Insights",
    description:
      "Add personal notes to any question and pin important ones to the top, making your learning process more organized and easy to revisit.",
  },
  {
    id: "04",
    title: 'Understand the "Why" Behind Answers',
    description:
      "Beyond just answers, unlock detailed concept explanations generated by AI, helping you truly master each topic with confidence.",
  },
  {
    id: "05",
